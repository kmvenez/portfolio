...
function Portfolio (props) {
  return (
    <div>
      ...
      <p id="disclaimer">Please note if prompted, <b>dummy login info:</b> user - katie@katie.com, PW - katie</p>
      <div className="card-deck">
        <div className="card">
          ...
          <div className="card-body">
            ...
            <p className="tech"><b>Tech:</b> React, React Router, Bootstrap, Heroku, Express, MongoDB, IntelliTicks, Javascript, HTML, SCSS.</p>
        ...
        <div className="card">
          ...
          <div className="card-body">
            ...
            <p className="tech"><b>Tech:</b> React, React Router, Express, Heroku, MongoDB, Javascript, HTML, SCSS.</p>
        ...
        <div className="card">
          ...
          <div className="card-body">
            ...
            <p className="tech"><b>Tech:</b> Express, MongoDB, jQuery, Javascript, HTML, SCSS.</p>
        ...
        <div className="card">
          ...
          <div className="card-body">
            ...
            <p className="tech"><b>Tech:</b> Javascript, HTML, CSS, jQuery.</p>
